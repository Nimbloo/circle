...
function SidebarProvider({
   ...
   // Em mobile/tablet o sidebar é um sheet sobre a página: navegar fecha (#56).
...
function SidebarGroupAction({
   ...
   return (
      <Comp
         ...
         className={cn(
            'text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-hover hover:text-sidebar-accent-foreground absolute top-2 right-4 flex aspect-square w-5 items-center justify-center rounded-lg p-0 outline-hidden transition-transform focus-visible:ring-2 [&>svg]:size-3.5 [&>svg]:shrink-0',
...
const sidebarMenuButtonVariants = cva(
   'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-lg px-2 text-left text-[13px] outline-hidden ring-sidebar-ring transition-[width,height,padding,background-color,color] duration-150 ease-out hover:bg-sidebar-hover hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-7! group-data-[collapsible=icon]:px-2! [&>span:last-child]:truncate [&>svg]:size-3.5 [&>svg]:shrink-0',
   {
      variants: {
         variant: {
