# CLAUDE.md — guia do projeto Circle

Instruções para o Claude (e humanos) evoluírem o Circle. Complementa o
...
Sem emoji. **Não** referencie IA/assistente/Claude no commit (sem `Co-Authored-By`, sem 🤖).
